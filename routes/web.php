...
->middleware(['auth','verified',isSeeker::class]);
...
Route::get('applicants' ,[ApplicantController::class, 'index'])->middleware(['verified',isEmployer::class])->name('applicants.index');
Route::get('applicants/{listing:slug}' ,[ApplicantController::class, 'show'])->middleware(['verified',isEmployer::class])->name('applicants.show');
