...
<div class="container mt-5">
	...
	<div class="row justify-content-center">
		...
		<div class="container-fluid px-4">
            ...
            <p>Please Subscribe <a href="{{ route('subscribe') }}">Click Here</a></p>
			@endif
						...
						<div class="col-md-4 col-xl-3">
							<div class="card bg-c-blue order-card">
								<div class="card-block">
									...
									<p class="m-b-0">
										<a href="/job">Your jobs</a>
										
										<span class="f-right">{{\App\Models\Listing::where('user_id',auth()->id())->count()}}</span></p>
								</div>
							</div>
						</div>
